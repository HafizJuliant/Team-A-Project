...
type AccountInterface interface {
	...
	Balance(*gin.Context)
	TopUp(*gin.Context)
	TransferLocal(*gin.Context)
	TransferOut(*gin.Context)
...
func (a *accountImplement) TransferLocal(c *gin.Context) {
	AccountID := c.GetInt64("account_id")
	payload := struct {
...
func (a *accountImplement) TransferOut(c *gin.Context) {
	AccountID := c.GetInt64("account_id")
	// BankID := c.GetInt64("bank_id")
	payload := struct {
		ToAccountID int64 `json:"to_account_id"`
		Amount      int64 `json:"amount"`
	}{}
